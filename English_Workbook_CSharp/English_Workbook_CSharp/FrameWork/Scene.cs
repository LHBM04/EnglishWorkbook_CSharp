...
namespace Scene
{
    ...
    public class TitleScene : scene
    {
        public override void MainMenu()
        {
            ...
            PRESS_ENTER:
                if (ToolManager.isPressKey(ConsoleKey.Enter))
                    break;
    ...
    public class ExamScene : scene
    {
        public ExamScene()
        {
            ...
            this.Menus = new string[] { "[단어 테스트]", "[불규칙동사 테스트]", "[속담 테스트]", "[문제 대난투]", "[뒤로 가기]" };
        }
            ...
            while (true)
            {
                ...
                switch (Act.Key)
                {
                    ...
                    case ConsoleKey.NumPad1:
                        ...
                        {
                            Console.Write("(해당 오답노트가 비어 있습니다.)");
                    ...
                    case ConsoleKey.NumPad4:
                        ...
                        {
                            Console.Write("(모든 오답노트가 비어 있습니다.)");
                            ToolManager.Press_Key(ConsoleKey.Enter);
                        }
                        break;
                    case ConsoleKey.D5:
